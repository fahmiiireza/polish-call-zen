...
const steps = [
  {
    icon: Link,
    title: "We Connect to Your Business Line",
  ...
  },
  {
    ...
    description: "No more stress, no more missed calls, just happy customers.",
    number: "03"
  }
];
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Here's How We Make It <span className="text-glow bg-gradient-to-r from-primary to-blue-400 bg-clip-text text-transparent">Simple</span>
          </h2>
        </div>
